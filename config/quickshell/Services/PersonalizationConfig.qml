...
Singleton {
    ...
    // @deprecated: matugenSchemes removed — user uses fixed Catppuccin Mocha palette

    property bool storeReady: false
    property bool loading: false
    property bool selfWrite: false

    property string wallpaperFolder: Paths.homeDir + "/Wallpapers"
    ...
    function setWallpaperFolder(value) {
        setValue("wallpaperFolder", value || Paths.homeDir + "/Wallpapers");
    }
    ...
    function loadFromObject(parsed) {
        ...
        root.wallpaperFolder = wallpaper.folder || Paths.homeDir + "/Wallpapers";
