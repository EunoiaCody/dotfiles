...
Also, check the [configuration introduction](./Configuration:-Introduction) page to get started configuring niri.
...
You're recommended to apply a manual fix documented [here](./Nvidia) if you run niri on an NVIDIA GPU.
