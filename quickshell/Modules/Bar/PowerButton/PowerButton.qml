...
// Standalone PowerButton — matches the StatIndet QuickSettings PowerButton
// style: 28px circle → 34px on hover, red `colError` background, ⏻ glyph
// centered with `colOnError` text. Click opens the power view in RightSidebar.
Item {
    id: root
