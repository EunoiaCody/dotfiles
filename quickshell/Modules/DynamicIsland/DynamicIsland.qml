        ...
        Item {
            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    ctx.bezierCurveTo(width, height * islandWindow.topEdgeCurveSideControlY, width * islandWindow.topEdgeCurveTopControlX, 0, 0, 0);
                    ctx.fill();
                }
            }
            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    ctx.lineTo(0, 0);
                    ctx.lineTo(0, height);
                    ctx.bezierCurveTo(0, height * islandWindow.topEdgeCurveSideControlY, width * (1 - islandWindow.topEdgeCurveTopControlX), 0, width, 0);
                    ctx.fill();
                }
            }
